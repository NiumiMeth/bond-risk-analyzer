...
4. **Dynamic Yield Adjustment**:
   - Users can input a new YTM value to see how it impacts the gain/loss for each bond in the portfolio.
...
3. **Dynamic Yield Adjustment**:
   - Enter a new YTM value in the input field to calculate the impact on the bond's gain/loss.
